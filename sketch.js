...
function setup() {
  ...
  bg.scale = 2.4
  //dragon1
  dragon1 = createSprite(width/5,480, 50, 50);
  dragon1.addAnimation("drgonImage1",dragonImage1);
  dragon1.scale = 0.7

//dragon2
  dragon2 = createSprite(width-300,480, 50, 50);
...
//to make the score invisible
 ...
 //creating function flame and flame1
  if(keyDown("space")){
    Flame()
  }
  Flame1()
...
//if the flame is touching dragon2 the score of dragon1 will increase
  ...
  // to make dragon2 move up and down
  if(dragon2.y<10){
     dragon2.velocityY = 10;
...
//if the score is more than 100 the flame and flame1 
  if(score>100){
    flame.visible = false;
...
function Flame(){
  ...
  flame = createSprite(width/5+200,480,50,50);
